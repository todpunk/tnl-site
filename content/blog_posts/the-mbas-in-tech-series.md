...
[The problem is they spread out from the Private Equity firms](/tnlblog/the-two-kinds-of-value.html) (again, you can see how some are useful but they are just extracting value at the end of the day, like the financial vultures they are). A Private Equity firm is there to make something an immediate investment value. I agree with the concept that the purpose of a business is to "maximize shareholder value" but unlike that statement I have to append "over the long term" because that's super important for where the value to shareholders _and society_ is.
...
[MBA-ification is a problem](/tnlblog/tech-is-the-revolutionary-equalizer.html). The solution is to talk about specific mechanisms it's a problem and how to not fall in those traps, so the number go up people can be more like a good investor in the future rather than a private equity vulture preying on a newborn. That's what this series will explore.
